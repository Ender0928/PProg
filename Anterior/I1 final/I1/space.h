...
/**
  ...
  *
  * @param space a pointer to the space
  * @param id an id, specifying the id of the object or if there is no object (NO_ID)
  * @return An id, if everything goes well or NO_ID if there was some mistake 
  */
...
/**
  ...
  *
  * @param space a pointer to the space
  * @return an id, specifying if in the space there is an object or not
  */
