...
void graphic_engine_paint_game(Graphic_engine *ge, Game *game) {
  ...
  sprintf(str, "     move or m (north or n, south or s, east or e, west or w), exit or e, take or t, drop or d, attack or a, chat or c, i or inspect,k or recruit,n or abandon");
  screen_area_puts(ge->help, str);
