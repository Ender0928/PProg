...
/**
 * @brief get the character that is an enemy at a specific location
 * 
 * @param game Pointer to the game structure.
 * @param location ID of the location to check.
 * @return the enemy character at the location, or NULL if none exists.
 */
Character *game_get_enemie_at_location(Game *game, Id location);
